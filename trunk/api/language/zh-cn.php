...
$_lang['Get recaptcha code ok!'] = '获取验证码成功！';
$_lang['Get recaptcha code fail!'] = '获取验证码失败！';
$_lang['Get authorized key fail!'] = '获取授权码失败！';
$_lang['Get authorized key ok!'] = '获取授权码成功！';
$_lang['Wrong method!'] = '错误的方法！';
