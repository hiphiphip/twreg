...
<body>
	...
	<form method="post" action="./create.php" id="signup">
        ...
        <div id="footer"><a href="http://code.google.com/p/twreg/" target="_blank"><?=_l('Get Source!')?></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="./" target="_blank"><?=_l('Get Widget!')?></a>&nbsp;&nbsp;&nbsp;&nbsp;<?=_l('Please feedback to')?> <a href="http://twitter.com/hfcorriez" target="_blank">@hfcorriez</a> <a href="http://twfav.com" target="_blank">@Twfav</a> Team</div>
    </div>
